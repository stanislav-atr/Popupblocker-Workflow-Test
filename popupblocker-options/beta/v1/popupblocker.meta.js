...
// @name:el Αποκλεισμός αναδυόμενων παραθύρων AdGuard (Beta)
// @name:es AdGuard Popup Blocker (Beta)
// @name:fa مسدودساز پاپ-آپ AdGuard (Beta)
// @name:fi AdGuard Ponnahdusesto (Beta)
// @name:fr Bloqueur de fenêtres pop-up de AdGuard (Beta)
// @name:he חוסם חלונות קופצים של AdGuard (Beta)
// @name:hr AdGuard Bloker skočnih prozora (Beta)
// @name:hu AdGuard Popup Blocker (Beta)
// @name:id Pemblokir Popup AdGuard (Beta)
// @name:it AdGuard Popup Blocker (Beta)
...
// @name:sr-CS AdGuard blokator iskačućih prozora (Beta)
// @name:ta AdGuard பாப்அப் தடுப்பான் (Beta)
// @name:th AdGuard Popup Blocker (Beta)
// @name:tr AdGuard Açılır Pencere Engelleyici (Beta)
// @name:uk Блокувальник спливних вікон AdGuard (Beta)
// @name:vi AdGuard Popup Blocker (Beta)
// @name:zh AdGuard 弹窗拦截器 (Beta)
// @name:zh-HK AdGuard 彈出式視窗封鎖器 (Beta)
